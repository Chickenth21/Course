...
2. **Common Components for Course Platform (EngVantage AI):**
   ...
   - **Feedback & Progress:**
     - `progress` (course completion % and IELTS/TOEIC progress trackers).
     - `skeleton` (loading placeholders for lessons, tests, user profiles).
   ...
   - **Navigation & Organisation:**
     - `tabs` (switch between Vocabulary, Grammar, Listening, Reading).
   ...
   - **Layout & Presentation:**
     ...
     - `avatar` (learner profile image and teacher avatars).
     - `tooltip` (helpful vocabulary definitions and grammar hints on hover).
     - `scroll-area` (lesson transcripts and long reading passages).
